...
from fablegear_database.database import BeatGridRecord, CueRecord
...
def test_export_track_anlz(tmp_path):
    ...
    mc_tag = next(t for t in pco2_tags if t.content.type == "memory")
    ...
    # Check hotcues tag
    hc_tag = next(t for t in pco2_tags if t.content.type == "hotcue")
